...
//     * @throws Exception 
//     * */
//    public static Wallet syncBlockchain(String seed, NetworkParameters params, final File walletFile, final File chainFile) throws UnreadableWalletException, BlockStoreException, InterruptedException  {
//
...
//        
//        //
////        DeterministicSeed dSeed = new DeterministicSeed("cannon side purity jaguar ability people faint vivid high immense nurse model", null, "", 1481551444);
////        
////        File walletFile = new File(appconfigProperties.getProperty("walletFile"));
////        
////        WalletAppKit appKit = new WalletAppKit(networkParameters, walletFile, "wallet");
////        
...
//    }
    ...
    public static Wallet createOrLoadWallet(String mnemonic, long creationTime, File walletFile, NetworkParameters params) throws UnreadableWalletException {
    ...
    public static void syncBC(NetworkParameters params, final Wallet wallet, final File chainFile, final File walletFile) {
...
//                }
     ...
     * */
    public static void createContract(NetworkParameters params, Wallet wallet, PeerGroup peers, String address1, String address2){
        try {
