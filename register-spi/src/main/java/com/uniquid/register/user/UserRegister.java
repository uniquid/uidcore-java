...
public interface UserRegister {
     ...
     * @throws RegisterException in case a problem occurs.
     */
    UserChannel getChannelByName(String providerName) throws RegisterException;
     ...
     * @throws RegisterException in case a problem occurs.
     */
    UserChannel getUserChannelByRevokeAddress(String revokerAddress) throws RegisterException;
